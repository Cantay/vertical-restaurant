...
class AccountJournal(models.Model):
    ...
    bank_code = fields.Selection(related='pos_provider_id.code', string='Banka Kodu', store=True)
...
class PosJournalEntry(models.Model):
    ...
    commission_amount = fields.Monetary(string='Komisyon Tutarı', default=0.0)
    installment_fee = fields.Monetary(string='Taksit Farkı', default=0.0)
    net_amount = fields.Monetary(string='Net Tutar', compute='_compute_net_amount')
