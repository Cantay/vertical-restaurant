...
class AccountMove(models.Model):
    ...
    vpos_order_id = fields.Many2one('vpos.order', string='POS Siparişi')
    ...
    # Taksit Bilgileri
    installment_count = fields.Integer(related='vpos_order_id.installment_count', 
                                        string='Taksit Sayısı', store=True)
    installment_amount = fields.Monetary(related='vpos_order_id.installment_amount',
