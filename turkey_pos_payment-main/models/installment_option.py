...
class InstallmentOption(models.Model):
    ...
    commission_amount = fields.Monetary(string='Komisyon Tutarı', compute='_compute_commission_amount')
    
    # Vade Farkı
    interest_rate = fields.Float(string='Vade Farkı Oranı (%)', default=0.0, digits=(5, 2))
    
    # Tutar Sınırları
    min_amount = fields.Monetary(string='Minimum Tutar', default=0.0)
    max_amount = fields.Monetary(string='Maksimum Tutar', default=999999.99)
...
class ProductCategoryInstallment(models.Model):
    ...
    custom_min_amount = fields.Monetary(string='Özel Minimum Tutar')
...
class SaleOrder(models.Model):
    ...
    installment_amount = fields.Monetary(string='Taksit Tutarı', compute='_compute_installment_amount')
    commission_amount = fields.Monetary(string='Komisyon Tutarı', compute='_compute_installment_amount')
